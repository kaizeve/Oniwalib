...
[![tests](https://img.shields.io/badge/tests-1056%2F1056%20passing-2ea44f?style=flat-square)](#tests)
...
Suite: **1056 / 1056 on bun**, **green on RTS** (`rts run` / `rts test`).
