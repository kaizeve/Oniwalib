...
[![tests](https://img.shields.io/badge/tests-1069%2F1069%20passing-2ea44f?style=flat-square)](#tests)
...
Suite: **1069 / 1069 on bun**, **green on RTS** (`rts run` / `rts test`).
