...
[![tests](https://img.shields.io/badge/tests-876%2F876%20passing-2ea44f?style=flat-square)](#tests)
...
`messages` 78 (incoming `pkmsg` → `messages.upsert` → `sendText`/`sendMessage`
