...
[![tests](https://img.shields.io/badge/tests-886%2F886%20passing-2ea44f?style=flat-square)](#tests)
...
`messages` 82 (incoming `pkmsg` → `messages.upsert` → `sendText`/`sendMessage`
