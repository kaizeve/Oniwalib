...
[![tests](https://img.shields.io/badge/tests-952%2F952%20passing-2ea44f?style=flat-square)](#tests)
...
`messages` 97 (incoming `pkmsg` → `messages.upsert` → `sendText`/`sendMessage`
