...
[![tests](https://img.shields.io/badge/tests-941%2F941%20passing-2ea44f?style=flat-square)](#tests)
...
`messages` 86 (incoming `pkmsg` → `messages.upsert` → `sendText`/`sendMessage`
